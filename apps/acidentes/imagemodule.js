(function (f) {
      ...
      "/js/index.js": [
        function (require, module, exports) {
          ...
          function getInnerPptx(_ref2) {
            ...
            if (ext.length > 0) {
              part.ext.cx = parseInt(
                ext[ext.length - 1].getAttribute("cx"),
                10
              );
              part.ext.cy = parseInt(
                ext[ext.length - 1].getAttribute("cy"),
                10
              );
            }
            if (offset.length > 0) {
              part.offset.x = parseInt(
                offset[offset.length - 1].getAttribute("x"),
                10
              );
              part.offset.y = parseInt(
                offset[offset.length - 1].getAttribute("y"),
                10
              );
            }
            return part;
            ...
            _createClass(ImageModule, [
              ...
              },
              {
                ...
                value: function render(part, options) {
                  ...
                  var rId = imgManager.addImageRels(
                    this.getNextImageName(),
                    imgBuffer
                  );
                  var sizePixel = this.options.getSize(
                    imgBuffer,
                    tagValue,
                    part.value
                  );
              ...
              },
              {
                ...
                value: function resolve(part, options) {
                  ...
                  return new Promise(function (resolve) {
                    ...
                    return new Promise(function (resolve) {
                      var sizePixel = _this.options.getSize(
                        imgBuffer,
                        value,
                        part.value
                      );
              ...
              },
              {
                ...
                value: function getRenderedPart(part, rId, sizePixel) {
                  ...
                  var newText = void 0;
                  if (this.fileType === "pptx") {
                    newText = this.getRenderedPartPptx(
                      part,
                      rId,
                      size,
                      centered
            ...
            _createClass(ImgManager, [
              {
                ...
                value: function createEmptyRelsDoc(xmlDocuments, relsFileName) {
                  var mainRels =
                    this.prefix + "/_rels/" + this.fileTypeName + ".xml.rels";
              ...
              },
              {
                ...
                value: function loadImageRels() {
                  var iterable =
                    this.relsDoc.getElementsByTagName("Relationship");
              ...
              },
              {
                ...
                value: function addExtensionRels(contentType, extension) {
                  ...
                  var defaultTags =
                    contentTypeDoc.getElementsByTagName("Default");
                  var extensionRegistered = Array.prototype.some.call(
                    defaultTags,
                    function (tag) {
              ...
              },
              {
                ...
                value: function addImageRels(imageName, imageData, i) {
                  ...
                  var relationships =
                    this.relsDoc.getElementsByTagName("Relationships")[0];
                  ...
                  newTag.setAttribute(
                    "Target",
                    this.mediaPrefix + "/" + realImageName
                  );
  ...
  */
          ...
          function isTextStart(part) {
            return (
              part.type === "tag" && part.position === "start" && part.text
            );
          }
              ...
              _createClass(Docxtemplater, [
                ...
                },
                {
                  ...
                  value: function setOptions(options) {
                    ...
                    if (options.delimiters) {
                      options.delimiters.start = utf8ToWord(
                        options.delimiters.start
                      );
                      options.delimiters.end = utf8ToWord(
                ...
                },
                {
                  ...
                  value: function loadZip(zip) {
                    ...
                    this.modules = concatArrays([
                      this.fileTypeConfig.baseModules.map(function (
                        moduleFunction
                      ) {
                ...
                },
                {
                  ...
                  value: function compile() {
                    ...
                    this.options = this.modules.reduce(function (
                      options,
                      module
                    ) {
                ...
                },
                {
                  ...
                  value: function createTemplateClassFromContent(
                    content,
                    filePath
                  ) {
                    var _this6 = this;
      ...
      6: [
        function (require, module, exports) {
          ...
          function throwUnimplementedTagType(part) {
            var err = new XTTemplateError(
              'Unimplemented tag type "'.concat(part.type, '"')
            );
            err.properties = {
              part: part,
        ...
        function (require, module, exports) {
          ...
          function tagMatcher(content, textMatchArray, othersMatchArray) {
            ...
            while (cursor < contentLength) {
              ...
              if (
                cursor === -1 ||
                (nextOpening !== -1 && cursor > nextOpening)
              ) {
          ...
          function getAllIndexes(fullText, delimiters) {
            ...
            while (true) {
              ...
              if (
                ...
                var nextEqual = fullText.indexOf(
                  "=",
          ...
          function Reader(innerContentParts) {
            ...
            this.parseDelimiters = function (delimiters) {
              ...
              _this.parsed = ranges.map(function (p, i) {
                ...
                var range = [
                  offset,
                  offset + this.innerContentParts[i].value.length,
                ];
                  ...
                  if (value.length > 0) {
                    if (insideDelimiterChange) {
                      if (delimiterInOffset.changedelimiter) {
                        ...
                        insideDelimiterChange =
                          delimiterInOffset.position === "start";
                      }
      ...
      11: [
        function (require, module, exports) {
          ...
          var expandPairTrait = {
            ...
            optionsTransformer: function optionsTransformer(
              options,
              docxtemplater
            ) {
            ...
            postparse: function postparse(postparsed, _ref) {
              ...
              var newParsed = postparsed.reduce(function (newParsed, part, i) {
                ...
                var before = getNearestLeft(
                  postparsed,
                  ["w:p", "w:tc"],
                  left - 1
                );
                var after = getNearestRight(
                  postparsed,
                  ["w:p", "w:tc"],
                  right + 1
                );
                ...
                },
                {
                  ...
                  value: function render(part, options) {
                    ...
                    function loopOver(scope, i) {
                      var scopeManager =
                        options.scopeManager.createSubScopeManager(
                          scope,
                          part.value,
                          i,
                          part
                ...
                },
                {
                  ...
                  value: function resolve(part, options) {
                    ...
                    return Promise.resolve(value)
                      .then(function (value) {
                        options.scopeManager.loopOverValue(
                          value,
                          loopOver,
                          part.inverted
                        );
              ...
              _createClass(Render, [
                ...
                },
                {
                  ...
                  value: function getRenderedMap(mapper) {
                    ...
                    return Object.keys(this.compiled).reduce(function (
                      mapper,
                      from
                    ) {
                      mapper[from] = {
            ...
            postrender: function postrender(parts) {
              return parts
                ...
                .reduce(function (newParts, p, index, parts) {
                  ...
                  if (
                    endsWith(p, wTpreserve) &&
                    startsWith(parts[index + 1], wtEnd)
                  ) {
        ...
        function (require, module, exports) {
          ...
          function match(condition, placeHolderContent) {
            if (typeof condition === "string") {
              return (
                placeHolderContent.substr(0, condition.length) === condition
              );
            }
        ...
        function (require, module, exports) {
          ...
          var _require = require("./errors"),
            getScopeParserExecutionError =
              _require.getScopeParserExecutionError;
          ...
          function getExpandToDefault(postparsed, pair, expandTags) {
            ...
            var _loop = function _loop(i, len) {
              ...
              if (has(contains, xmlElements)) {
                if (onlyTextInTag) {
                  var left = getLeftOrNull(
                    postparsed,
                    contains,
                    pair[0].offset
                  );
                  var right = getRightOrNull(
                    postparsed,
                    contains,
                    pair[1].offset
                  );
                ...
                set: function (data) {
                  switch (this.nodeType) {
                    ...
                    case DOCUMENT_FRAGMENT_NODE:
                      ...
                      if (data || String(data)) {
                        this.appendChild(
                          this.ownerDocument.createTextNode(data)
                        );
                      }
                      break;
                    default:
